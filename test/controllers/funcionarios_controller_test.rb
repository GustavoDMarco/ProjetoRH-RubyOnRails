...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { admissao: @funcionario.admissao, cpf: @funcionario.cpf, email: @funcionario.email, empresa_id: @funcionario.empresa_id, idade: @funcionario.idade, nome: @funcionario.nome, salario: @funcionario.salario, setor_id: @funcionario.setor_id, tel: @funcionario.tel } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { admissao: @funcionario.admissao, cpf: @funcionario.cpf, email: @funcionario.email, empresa_id: @funcionario.empresa_id, idade: @funcionario.idade, nome: @funcionario.nome, salario: @funcionario.salario, setor_id: @funcionario.setor_id, tel: @funcionario.tel } }
